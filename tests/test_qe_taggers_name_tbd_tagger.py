    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                6,
                3,
                [(0, 0, 0.5), (2, 0, 0.5), (3, 1, 0.5), (5, 2, 0.5), (6, 0, 0.5)],
                [(0, 0, 0.5), (1, None, None), (2, 0, 0.5), (3, 1, 0.5), (4, None, None), (5, 2, 0.5), (6, 0, 0.5)],
            ),
            (
                3,
                3,
                [(0, 0, 0.5), (0, 1, 0.5), (0, 2, 0.5), (2, 0, 0.5)],
                [(0, 0, 0.5), (0, 1, 0.5), (0, 2, 0.5), (1, None, None), (2, 0, 0.5)],
            ),
